...
@section('content')
    <form class="mt-4" action="/create/video" method="POST">
        @csrf
        ...
        <div class="mb-3 mt-4 row">
            ...
            <div class="col">
                ...
                <input type="text" class="form-control" name="judul" id="judul" value="{{ $playlist->judul }}"
                    hidden>
            </div>
        </div>
        <div class="mb-3 mt-4 row">
        ...
        <div class="mt-3 mb-4 row ">
            ...
            <div class="col">
                <div class="form-floating">
                    <textarea class="form-control" placeholder="Leave a comment here" id="deskripsi" name="deskripsi" style="height: 120px"></textarea>
        ...
        <div class="d-grid gap-3 d-md-block mt-5" style="margin-bottom: 5rem;">
            ...
            <a href="/mentor/mycourse" class="btn cancel btn-lg">Back to Home</a>
        </div>
        <br>
        <br>
    </form>
